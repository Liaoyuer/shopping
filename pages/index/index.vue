<template>
	<view class="homepage">
		<view class="page-header">
			<view class="top width-90 flex justify-between">
				<view class="local flex justify-between">
					<image src="../../static/images/home/weizhi.png" mode=""></image>
					<text>我的位置</text>
				</view>
				<view class="weather flex justify-between">
					<image src="../../static/images/weather/duoyun.png" mode=""></image>
					<text>多云 /21℃</text>
				</view>
			</view>
			<!-- 搜索条 -->
		...
		<view class="goods-classify width-90">
			<u-grid :col="5">
				<u-grid-item v-for="(item,index) in categoryList" :key="item.id">
		...
		<!-- 公告 -->
		<view class="notice width-90 flex">
			<u-icon name="volume" color="#fa5376" size="40"></u-icon>
			<u-notice-bar class="notice-text" :volume-icon="false" mode="vertical" :list="notice" type="info" :more-icon="true" border-radius="8"></u-notice-bar>
			<u-icon name="arrow-right" color="#ccc" size="32"></u-icon>
		</view>
		<!-- 广告 -->
		<view class="banner flex justify-between width-90">
			<view class="left">
			...
			<view class="right flex-direction">
		...
		<!-- 热门标题 -->
		<view class="hotstitle width-90 flex">
			<view class="">
				<u-icon name="integral" color="#fa5376" size="60"></u-icon>
			</view>
			<view class="text flex-direction">
				<text class="p1">新品上市</text>
				<text class="p2">New Products Listed</text>
			</view>
...
<style lang="scss">
	...
	.homepage{
		...
		.page-header{
			height: 514rpx;
			background: #fa5376;
			background-image: linear-gradient(#fa5376, #fff);
			.top{
				padding-top: 20rpx;
				color: #fff;
				font-size: 16rpx;
